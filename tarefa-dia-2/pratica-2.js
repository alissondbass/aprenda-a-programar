...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): if
if (10 <= a) {
    console.log("Verdade! O valor ", a, " é menor ou igual a 10"); //Corrigido. Pois a comparação é se é menor ou igual e não maior ou igual.
} else {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): if (pois os valores do array são diferentes de zero)
if (d) {
